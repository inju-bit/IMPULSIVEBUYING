...
Data Overview - Basic stats about the dataset
EDA - Charts showing how responses are distributed
Correlations - Cramér's V heatmaps to see relationships
ML Models - Train 6 different classifiers:
Random Forest
Extra Trees
Gradient Boosting
XGBoost
LightGBM
CatBoost
Results - Compare accuracy, F1 scores, confusion matrices
PLS-SEM - Structural equation modeling to test my hypotheses
How to run it
